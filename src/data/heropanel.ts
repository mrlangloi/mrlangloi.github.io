...
export const heroLines: CodeLine[] = [
    ...
    { indent: 2, tokens: [s('Java'), p(','), _(' '), s('Python'), p(','), _(' '), s('C++'), p(','), _(' '), s('C'), p(',')] },
    { indent: 2, tokens: [s('SQL'), p(','), _(' '), s('HTML'), p(','), _(' '), s('CSS'), p(',')] },
    { indent: 1, tokens: [p('],')] },
    ...
    { indent: 2, tokens: [s('VS Code'), p(','), _(' '), s('Git'), p(','), _(' '), s('Docker'), p(','), _(' '), s('Jest'), p(',')] },
    { indent: 2, tokens: [s('VJUnit'), p(','), _(' '), s('IntelliJ'), p(',')]  },
    { indent: 1, tokens: [p('],')] },
